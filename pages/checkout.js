...
export default function checkOut() {
  return (
    <>
    <Navbar/>
      <div class="min-w-screen min-h-screen px-40 bg-gray-50 py-5">
          <div class="px-5">
              <div class="mb-2">
                  <a href="/product/test01" class="focus:outline-none hover:underline text-gray-500 text-sm"><i class="mdi mdi-arrow-left text-gray-400 cursor-pointer hover:underline"></i>Back</a>
              </div>
              <div class="mb-2">
          ...
          <div class="w-full mt-10 bg-white border-t border-b border-gray-200 px-5 py-10 text-gray-800">
              <div class="w-full">
